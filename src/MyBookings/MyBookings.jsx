...
import cta from "../assets/caroffer1.png";
...
export default function MyBookings() {
  ...
  //Separate page/component to render all the booked cars of user alogwith chosen date and time slot
  //It utilises CarCard component to generate the cards with data
  return (
    <>
      <NavBar />
      <Box
